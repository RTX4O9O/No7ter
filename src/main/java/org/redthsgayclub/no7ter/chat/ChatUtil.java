...
import org.redthsgayclub.no7ter.asm.accessors.GuiChatAccessor;
import org.redthsgayclub.no7ter.asm.accessors.NetworkPlayerInfoAccessor_ChatHeads;
...
public class ChatUtil {
    ...
    public static String getTagMW() {
        return DARK_GRAY + "[" + DARK_PURPLE + "P" + DARK_GRAY + "] ";
    }
