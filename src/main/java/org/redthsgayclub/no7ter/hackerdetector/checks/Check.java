...
import org.redthsgayclub.no7ter.chat.FlagChatComponent;
...
import org.redthsgayclub.no7ter.hackerdetector.utils.Vector3D;
...
public abstract class Check implements ICheck {
    ...
    private void printFlagMessage(EntityPlayer player) {
        ...
        final String msg = ChatUtil.getTagNoCheaters() + EnumChatFormatting.RESET
                ...
                + EnumChatFormatting.WHITE + " has flagged "
