...
public enum ClassMapping {
    ...
    MWCLASS("org/redthsgayclub/no7ter/enums/MWClass"),
    ...
    PLAYERDATASAMPLES("org/redthsgayclub/no7ter/hackerdetector/data/PlayerDataSamples"),
    ...
    SKINCHATHEAD("org/redthsgayclub/no7ter/chat/SkinChatHead"),
